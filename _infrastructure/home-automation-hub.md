...
| Samsung SmartThings v2 | Home Assistant v0.88 |
|:-------:|:--------:|
| ![SmartThings photo](\assets\images\product-photo\smartthings.jpg){:.image--sm.align-center} | ![Home Assistant photo](\assets\images\product-photo\asus-tinkerboard.jpg){:.image--sm} |
...
![Home Assistant logo](\assets\images\logo\home-assistant.png){:.image--md}  ![Smartthings logo](\assets\images\logo\smartthings.jpg){:.image--lg} 
...
![SmartThings UI](\assets\images\other\smartthings-app.jpg)
...
![Home Assistant UI](\assets\images\other\homeassistant-02.jpg)
...
![Home Assistant Media UI](\assets\images\other\homeassistant-media.jpg)
...
### The Competition
![Hubitat logo](\assets\images\logo\hubitat.png){:.image--lg}
